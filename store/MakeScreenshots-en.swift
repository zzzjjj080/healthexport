...
let shots = [
    Shot(file: "01-home.png",     title: "Your Health records,\nready for an AI",
         subtitle: "Pick a purpose. Period, metrics and the request are set for you"),
    Shot(file: "02-result.png",   title: "One text file,\nready to paste",
         subtitle: "It tells you whether it fits in a chat box"),
    Shot(file: "03-detail.png",   title: "See what goes out\nbefore it does",
         subtitle: "Only the metrics that actually have records"),
    Shot(file: "04-settings.png", title: "Change anything\nif you want to",
         subtitle: "Metrics, layout, units and language"),
]
...
for shot in shots {
    ...
    let titleAttributes: [NSAttributedString.Key: Any] = [
        .font: NSFont(name: "HiraginoSans-W7", size: 66 * uiScale) ?? NSFont.systemFont(ofSize: 84 * uiScale, weight: .bold),
    ...
    let subtitleAttributes: [NSAttributedString.Key: Any] = [
        .font: NSFont(name: "HiraginoSans-W3", size: 36 * uiScale) ?? NSFont.systemFont(ofSize: 44 * uiScale),
