...
public enum Tr {
    ...
    static let export: [String: [Language: String]] = [
        "title": [.ja: "# ヘルスケアの記録", .en: "# Health data export", .zhHans: "# “健康”数据记录", .zhHant: "# 「健康」資料記錄", .ko: "# 건강 기록", .es: "# Registros de Salud", .fr: "# Données Santé", .de: "# Health-Daten", .it: "# Dati di Salute", .ptBR: "# Registros da Saúde", .ru: "# Данные «Здоровья»", .ar: "# سجلات «الصحة»"],
        "period": [.ja: "期間: {from} 〜 {to}（{days}日間）", .en: "Period: {from} to {to} ({days} days)", .zhHans: "时间范围：{from} 〜 {to}（{days} 天）", .zhHant: "時間範圍：{from} 〜 {to}（{days} 天）", .ko: "기간: {from} ~ {to} ({days}일간)", .es: "Periodo: del {from} al {to} ({days} días)", .fr: "Période : du {from} au {to} ({days} jours)", .de: "Zeitraum: {from} bis {to} ({days} Tage)", .it: "Periodo: dal {from} al {to} ({days} giorni)", .ptBR: "Período: de {from} a {to} ({days} dias)", .ru: "Период: с {from} по {to} ({days} дн.)", .ar: "الفترة: من {from} إلى {to} ({days} يوم)"],
        "notListed": [.ja: "（記載しない）", .en: "(not listed)", .zhHans: "（未列出）", .zhHant: "（未列出）", .ko: "(표시하지 않음)", .es: "(no indicado)", .fr: "(non indiqué)", .de: "(nicht angegeben)", .it: "(non indicato)", .ptBR: "(não informado)", .ru: "(не указано)", .ar: "(غير مذكور)"],
        "exported": [.ja: "書き出し: {stamp} / ヘルスケア書き出し", .en: "Exported: {stamp} / Health for AI", .zhHans: "导出时间：{stamp} / Health for AI", .zhHant: "匯出時間：{stamp} / Health for AI", .ko: "내보낸 시각: {stamp} / Health for AI", .es: "Exportado: {stamp} / Health for AI", .fr: "Exporté le : {stamp} / Health for AI", .de: "Exportiert: {stamp} / Health for AI", .it: "Esportato: {stamp} / Health for AI", .ptBR: "Exportado: {stamp} / Health for AI", .ru: "Выгружено: {stamp} / Health for AI", .ar: "تاريخ التصدير: {stamp} / Health for AI"],
        "recordedBy": [.ja: "記録した端末: {devices}", .en: "Recorded by: {devices}", .zhHans: "记录设备：{devices}", .zhHant: "記錄裝置：{devices}", .ko: "기록한 기기: {devices}", .es: "Registrado por: {devices}", .fr: "Enregistré par : {devices}", .de: "Aufgezeichnet von: {devices}", .it: "Registrato da: {devices}", .ptBR: "Registrado por: {devices}", .ru: "Записано устройствами: {devices}", .ar: "سجّلته الأجهزة: {devices}"],
        "metricCount": [.ja: "項目数: {count}", .en: "Metrics: {count}", .zhHans: "项目数：{count}", .zhHant: "項目數：{count}", .ko: "항목 수: {count}", .es: "Métricas: {count}", .fr: "Mesures : {count}", .de: "Werte: {count}", .it: "Metriche: {count}", .ptBR: "Métricas: {count}", .ru: "Показателей: {count}", .ar: "عدد البيانات: {count}"],
        "note1": [.ja: "この文書はiPhoneのヘルスケアから本人が書き出したもの。", .en: "Exported by the owner from the Health app on iPhone.", .zhHans: "本文档由本人从 iPhone 的“健康”App 导出。", .zhHant: "本文件由本人從 iPhone 的「健康」App 匯出。", .ko: "이 문서는 본인이 iPhone 건강 앱에서 내보낸 것입니다.", .es: "Exportado por su titular desde la app Salud del iPhone.", .fr: "Exporté par son propriétaire depuis l'app Santé de l'iPhone.", .de: "Vom Besitzer aus der Health-App des iPhone exportiert.", .it: "Esportato dal titolare dall'app Salute dell'iPhone.", .ptBR: "Exportado pelo próprio titular a partir do app Saúde do iPhone.", .ru: "Выгружено владельцем из приложения «Здоровье» на iPhone.", .ar: "صدّره صاحبه من تطبيق «الصحة» على iPhone."],
        "note2": [.ja: "値は同じ項目に複数の端末が記録した重複を、ヘルスケアが除いたあとの数字。", .en: "Values are what Health reports after removing duplicates recorded by more than one device.", .zhHans: "数值是“健康”去除多台设备对同一项目的重复记录之后的结果。", .zhHant: "數值是「健康」去除多台裝置對同一項目的重複記錄之後的結果。", .ko: "값은 여러 기기가 같은 항목을 중복 기록한 것을 건강 앱이 제외한 뒤의 숫자입니다.", .es: "Los valores son los que da Salud tras quitar los duplicados registrados por más de un dispositivo.", .fr: "Les valeurs sont celles fournies par Santé après suppression des doublons enregistrés par plusieurs appareils.", .de: "Die Werte sind das, was Health nach Entfernen doppelter Einträge mehrerer Geräte meldet.", .it: "I valori sono quelli riportati da Salute dopo aver rimosso i duplicati registrati da più dispositivi.", .ptBR: "Os valores são os que a Saúde informa depois de remover duplicatas registradas por mais de um dispositivo.", .ru: "Значения — это то, что сообщает «Здоровье» после удаления дублей от нескольких устройств.", .ar: "القيم هي ما يذكره «الصحة» بعد إزالة التكرارات التي سجّلها أكثر من جهاز."],
        "note3": [.ja: "空欄・欠けている日は「記録が無い」ことを表す（値が0という意味ではない）。", .en: "A blank or missing day means no record exists (it does not mean zero).", .zhHans: "空白或缺少的日期表示“没有记录”（并不表示数值为 0）。", .zhHant: "空白或缺少的日期表示「沒有記錄」（並不表示數值為 0）。", .ko: "빈칸이나 빠진 날은 '기록이 없음'을 뜻합니다(값이 0이라는 뜻이 아닙니다).", .es: "Una casilla vacía o un día que falta significa que no hay registro (no significa cero).", .fr: "Une case vide ou un jour manquant signifie qu'il n'y a pas d'enregistrement (et non zéro).", .de: "Ein leeres Feld oder fehlender Tag bedeutet, dass keine Aufzeichnung existiert (nicht null).", .it: "Una cella vuota o un giorno mancante significa che non ci sono dati (non significa zero).", .ptBR: "Uma célula vazia ou um dia ausente significa que não há registro (não significa zero).", .ru: "Пустая ячейка или пропущенный день означают, что записи нет (а не ноль).", .ar: "الخانة الفارغة أو اليوم الناقص يعني عدم وجود سجل (ولا يعني صفراً)."],
        "daily": [.ja: "## 日ごとの記録", .en: "## Daily values", .zhHans: "## 每日记录", .zhHant: "## 每日記錄", .ko: "## 일별 기록", .es: "## Valores diarios", .fr: "## Valeurs par jour", .de: "## Tageswerte", .it: "## Valori giornalieri", .ptBR: "## Valores diários", .ru: "## Значения по дням", .ar: "## القيم اليومية"],
        "workouts": [.ja: "## ワークアウト", .en: "## Workouts", .zhHans: "## 体能训练", .zhHant: "## 體能訓練", .ko: "## 운동 기록", .es: "## Entrenamientos", .fr: "## Entraînements", .de: "## Workouts", .it: "## Allenamenti", .ptBR: "## Treinos", .ru: "## Тренировки", .ar: "## التمارين"],
        "countWrap": [.ja: "（{n}）", .en: " ({n})", .zhHans: "（{n}）", .zhHant: "（{n}）", .ko: " ({n})", .es: " ({n})", .fr: " ({n})", .de: " ({n})", .it: " ({n})", .ptBR: " ({n})", .ru: " ({n})", .ar: " ({n})"],
        "noRecords": [.ja: "（この期間に記録なし）", .en: "(no records in this period)", .zhHans: "（此期间没有记录）", .zhHant: "（此期間沒有記錄）", .ko: "(이 기간에 기록 없음)", .es: "(sin registros en este periodo)", .fr: "(aucun enregistrement sur cette période)", .de: "(keine Aufzeichnungen in diesem Zeitraum)", .it: "(nessun dato in questo periodo)", .ptBR: "(sem registros neste período)", .ru: "(за этот период записей нет)", .ar: "(لا توجد سجلات في هذه الفترة)"],
        "wStart": [.ja: "開始", .en: "start", .zhHans: "开始", .zhHant: "開始", .ko: "시작", .es: "inicio", .fr: "début", .de: "Start", .it: "inizio", .ptBR: "início", .ru: "начало", .ar: "البدء"],
        "wKind": [.ja: "種目", .en: "kind", .zhHans: "类型", .zhHant: "類型", .ko: "종목", .es: "tipo", .fr: "type", .de: "Art", .it: "tipo", .ptBR: "tipo", .ru: "вид", .ar: "النوع"],
        "wMinutes": [.ja: "分", .en: "minutes", .zhHans: "分钟", .zhHant: "分鐘", .ko: "분", .es: "minutos", .fr: "minutes", .de: "Minuten", .it: "minuti", .ptBR: "minutos", .ru: "мин", .ar: "دقائق"],
        "wHr": [.ja: "平均心拍", .en: "hr_avg", .zhHans: "平均心率", .zhHant: "平均心率", .ko: "평균 심박", .es: "FC media", .fr: "FC moy.", .de: "Ø Puls", .it: "FC media", .ptBR: "FC média", .ru: "ср. пульс", .ar: "متوسط النبض"],
        "rawDatetime": [.ja: "日時", .en: "datetime", .zhHans: "日期时间", .zhHant: "日期時間", .ko: "일시", .es: "fecha y hora", .fr: "date et heure", .de: "Zeitpunkt", .it: "data e ora", .ptBR: "data e hora", .ru: "дата и время", .ar: "التاريخ والوقت"],
        "rawValue": [.ja: "値", .en: "value", .zhHans: "数值", .zhHant: "數值", .ko: "값", .es: "valor", .fr: "valeur", .de: "Wert", .it: "valore", .ptBR: "valor", .ru: "значение", .ar: "القيمة"],
        "rawStart": [.ja: "開始", .en: "start", .zhHans: "开始", .zhHant: "開始", .ko: "시작", .es: "inicio", .fr: "début", .de: "Beginn", .it: "inizio", .ptBR: "início", .ru: "начало", .ar: "البدء"],
        "rawEnd": [.ja: "終了", .en: "end", .zhHans: "结束", .zhHant: "結束", .ko: "종료", .es: "fin", .fr: "fin", .de: "Ende", .it: "fine", .ptBR: "fim", .ru: "конец", .ar: "الانتهاء"],
        "rawStage": [.ja: "段階", .en: "stage", .zhHans: "阶段", .zhHant: "階段", .ko: "단계", .es: "fase", .fr: "phase", .de: "Phase", .it: "fase", .ptBR: "fase", .ru: "фаза", .ar: "المرحلة"],
        "rawDetail": [.ja: " 詳細（全 {n} 件）", .en: " detail ({n} samples)", .zhHans: " 详细（共 {n} 条）", .zhHant: " 詳細（共 {n} 筆）", .ko: " 상세 (전체 {n}건)", .es: " detalle ({n} muestras)", .fr: " détail ({n} échantillons)", .de: " Einzelwerte ({n} Messungen)", .it: " dettaglio ({n} campioni)", .ptBR: " detalhe ({n} amostras)", .ru: " подробно ({n} записей)", .ar: " التفاصيل ({n} عيّنة)"],
        "truncated": [.ja: "\n（多すぎるため、古いほうから {n} 件だけ載せています）", .en: "\n(too many to include; only the first {n} are listed)", .zhHans: "\n（数量太多，只列出最早的 {n} 条）", .zhHant: "\n（數量太多，只列出最早的 {n} 筆）", .ko: "\n(너무 많아서 오래된 것부터 {n}건만 실었습니다)", .es: "\n(demasiadas para incluirlas; solo se listan las primeras {n})", .fr: "\n(trop nombreux ; seuls les {n} premiers sont listés)", .de: "\n(zu viele; nur die ersten {n} sind aufgeführt)", .it: "\n(troppi da includere; sono elencati solo i primi {n})", .ptBR: "\n(muitas para incluir; só as primeiras {n} estão listadas)", .ru: "\n(слишком много; приведены только первые {n})", .ar: "\n(العدد كبير جداً؛ أُدرجت أول {n} فقط)"],
        "columns": [.ja: "## 列の意味", .en: "## Column meanings", .zhHans: "## 列的含义", .zhHant: "## 欄位的含義", .ko: "## 열의 의미", .es: "## Significado de las columnas", .fr: "## Signification des colonnes", .de: "## Bedeutung der Spalten", .it: "## Significato delle colonne", .ptBR: "## Significado das colunas", .ru: "## Значение столбцов", .ar: "## معاني الأعمدة"],
        "unitWrap": [.ja: "（{unit}）", .en: " ({unit})", .zhHans: "（{unit}）", .zhHant: "（{unit}）", .ko: " ({unit})", .es: " ({unit})", .fr: " ({unit})", .de: " ({unit})", .it: " ({unit})", .ptBR: " ({unit})", .ru: " ({unit})", .ar: " ({unit})"],
        "aggSep": [.ja: " ／{agg}", .en: " / {agg}", .zhHans: " ／{agg}", .zhHant: " ／{agg}", .ko: " / {agg}", .es: " / {agg}", .fr: " / {agg}", .de: " / {agg}", .it: " / {agg}", .ptBR: " / {agg}", .ru: " / {agg}", .ar: " / {agg}"],
    ]
